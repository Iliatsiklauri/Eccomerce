...
export class ResetDatabase1732191262466 implements MigrationInterface {
    name = 'ResetDatabase1732191262466'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "message" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "senderId" integer, "recieverId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_9cad3f146f607c5214f7b386ca5" FOREIGN KEY ("recieverId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
